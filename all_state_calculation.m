...
load in_model_odd_even_neff(130458).mat;% this file is the neff of even and odd mode of a directional coupler
load('available_L.mat')% this is the resonance length of ring
lambda_target=1.30458E-6;
neff=2.528240496;% the neff at the operating wavelength
...
[ae,be,ao,bo]=coupler_fitting(gap,ne,no,startpoint,neff);%ae,ao,be,bo are determind by the geometry of waveguide
width=380;%unit:nm

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
resolution=116;
R_vector=all_L(1:116)*1E9/(2*pi);%give the radius of microring resonator, this can be obtained by all_L/2pi
...
neff_file_name='in_model_neff_width_380.csv';%the name of the effective index file
ng_file_name='in_model_ng_width_380.csv';%the name of the group index file
